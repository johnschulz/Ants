...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while place != hive:
            if place.bees and distance >= self.min_range and distance < self.max_range:
            ...
            while place:
                ...
                if ant:
                    ...
                    if isinstance(ant, BodyguardAnt):
                            inner = ant.ant
                            if inner and inner not in QueenAnt.doubled_ants:
                                inner.damage *= 2
                                QueenAnt.doubled_ants.append(inner)
                place = place.exit
        else:
